...
import { X, Home, User, Settings, Info, LogOut, Droplets, ChevronRight, Moon, Sun, ShieldCheck, Heart, Users, History, Package, Activity } from 'lucide-react-native';
...
export default function Sidebar({
  ...
  const menuItems: { id: string; label: string; icon: any }[] = user?.isAdmin ? [
    { id: 'AdminDashboard', label: 'Dashboard', icon: ShieldCheck },
    { id: 'AdminRequests', label: 'Requests', icon: Droplets },
    { id: 'AdminUsers', label: 'Users', icon: Users },
    { id: 'AdminDonors', label: 'Donors', icon: Package },
    { id: 'AdminInventory', label: 'Inventory', icon: Activity },
    { id: 'AdminActivity', label: 'Activity', icon: History },
    ...
    { id: 'AvailableBlood', label: 'Inventory', icon: Activity },
    { id: 'Settings', label: t('settings'), icon: Settings },
    { id: 'logout', label: t('logout'), icon: LogOut },
  ];
